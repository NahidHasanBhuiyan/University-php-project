...
<html>
<head>
<title>Bhuiyan Group | Factory</title>
            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left" style="background-color: #00bfff; padding: 3px">
							<div class="logo-nam">
									 <h1 class="text-center text-uppercase" style="padding: 5px;color: #FFF;"><b>Bhuiyan Group Factory</b></h1> 
...
<div class="inner-block" style="background-image: url('images/b6.jpg'); background-size: cover; background-attachment: fixed;">
<!--market updates updates-->
	 <div class="container-fluid" >
		...
		<div class="row">
			<div class="col-md-4">
				<div class="card " style="margin-top: 18px">
					<a href="factory/order/order.php"><button class="card-body btn btn-info text-uppercase" style="height: 190px; width: 100%"><h1><i class="fa fa-cart-plus fa-lg"></h1></i></h1><h3 style="padding-top: 10px;">Advanceded Order <span class="badge"><?php echo $row;?></span></h3></button></a>
				</div>
			</div>
			<div class="col-md-4">
				<div class="card " style="margin-top: 18px" >

					<a href="factory/rm/rm.php"><button class="card-body btn btn-info text-uppercase" style="height: 190px; width: 100%"><h1><i class="fa fa-industry"></i></h1></h1><h3 style="padding-top: 10px">Row Material</h3></button></a>
				</div>
			</div>
			<div class="col-md-4">
				<div class="card " style="margin-top: 18px" >
				<a href="factory/expense/expense.php"><button class="card-body btn btn-info text-uppercase" style="height: 190px; width: 100%"><h1><i class="fa fa-money fa-lg"></i></h1><h3 style="padding-top: 10px">Expenses</h3></button></a>
				</div>
			</div>
		...
		<div class="row" style="margin-top: 17px;">
			<div class="col-md-4">
				<div class="card " style=" margin-top: 18px">
				<a href="factory/product/product.php"><button class="card-body btn btn-info text-uppercase" style="height: 190px; width: 100%"><h1><i class="fa fa-birthday-cake fa-lg"></i></h1><h3 style="padding-top: 10px">Product</h3></button></a>
				</div>
			</div>
			<div class="col-md-4">
				<div class="card " style="margin-top: 18px" >
					<a href="factory/facReports/facReports.php"><button class="card-body btn btn-info text-uppercase" style="height: 190px; width: 100%"><h1><i class="fa fa-home fa-lg"></i></h1><h3 style="padding-top: 10px">Factory Reports</h3></button></a>
				</div>
			</div>
			<div class="col-md-4">
				<div class="card " style="margin-top: 18px" >
					<a href="factory/outReports/outReports.php"><button class="card-body btn btn-info text-uppercase" style="height: 190px; width: 100%"><h1><i class="fa fa-bar-chart fa-lg"></i></h1><h3 style="padding-top: 10px">Outlet Reports</h3>
		...
		<p class="alert" style="text-align: center; margin-top: 50px;background-color: #00bfff; color: #FFF">Powered By @ NAHID HASAN BHUIYAN & TEAM</p>
