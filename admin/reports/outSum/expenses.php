...
<html>
<head>
<title>Bhuiyan Group | Reports | Outlet Summary | Expenses</title>
            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left" style="background-color: #00bfff; ">
							<div class="logo-nam">
									 <h1 class="text-center" style="padding: 5px; color: #fff"><b>Expenses</b></h1> 
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                	<div class="row">
                                		<div class="col-md-6">
                                    <h3 class="alert alert-danger"><b class="text-left">Total Expense :</b ></h3>
                                    </div>
                                    <div class="col-md-6">
                                    		<?php
                                        	...
                                        	?>
                                    <h3 class="alert alert-danger"><span class="text-right"><b>BDT <?php echo (double)$exp6['exp5']?></b></span></h3>
                                    </div>
                                    </div>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <tbody>
                                        	<?php
                                        		$exp = $conn->query("SELECT SUM(outExpAmount) as exp1,expOutlet FROM outletExpense WHERE outExpStatus='Confirmed' AND outExpDate='$today' GROUP BY expOutlet ");
                                        		$i=1;
                                        		while($exp2=$exp->fetch_assoc()):
                                        	?>
                                            <tr>
                                                <td></td>
                                                <td>1</td>
                                                <td><?php echo $exp2['expOutlet']?></td>
                                                <td><?php echo $exp2['exp1']?> <span>TK</span></td>
