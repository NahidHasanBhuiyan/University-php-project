...
<html>
<head>
<title>Bhuiyan Group | Reports | Outlet Summary | Wastage</title>
            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left" style="background-color: #00bfff; ">
							<div class="logo-nam">
									 <h1 class="text-center" style="padding: 5px; color: #fff"><b>Wastage</b></h1> 
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                	<div class="row">
                                		<div class="col-md-6">
                                    <h3 class="alert alert-warning"><b class="text-left">Total Wastage :</b ></h3>
                                    </div>
                                    <div class="col-md-6">
                                    		<?php
                                        	...
                                        	?>
                                    <h3 class="alert alert-warning"><span class="text-right"><b>BDT <?php echo (double)$was5['wasTotal1']?></b></span></h3>
                                    </div>
                                    </div>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <tbody>
                                        	<?php
                                        		$was = $conn->query("SELECT SUM(wasOutPrice) as wasTotal,wasOutlet FROM wastageoutlet WHERE wasStatus='Confirmed' AND wasDate='$today' GROUP BY wasOutlet ");
                                        		$i=1;
                                        		while($was1=$was->fetch_assoc()):
                                        	?>
                                            <tr>
                                                <td></td>
                                                <td>1</td>
                                                <td><?php echo $was1['wasOutlet']?></td>
                                                <td><?php echo $was1['wasTotal']?> <span>TK</span></td>
		      ...
		      <ul id="menu" >
		        ...
		        <li><a href="#"><i class="fa fa-envelope"></i><span>Monthly Analysis</span><span class="fa fa-angle-right" style="float: right"></span></a>
		        	 <ul id="menu-academico-sub" >
			            ...
			            <li id="menu-academico-boletim" ><a href="../../../admin/monthly/distGap.php">RM Purchases</a></li>
