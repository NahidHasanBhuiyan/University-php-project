...
<html>
<head>
<title>Bhuiyan Group | Reports | Outlet Summary | Orders</title>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                	<div class="row">
                                		<div class="col-md-6">
                                    <h3 class="alert alert-success"><b class="text-left">Total Advance Order :</b ></h3>
                                    </div>
                                    <div class="col-md-6">
                                    		<?php
                                        	...
                                        	?>
                                    <h3 class="alert alert-success"><span class="text-right"><b><?php echo (int)$order5['row1']?></b></span></h3>
                                    </div>
                                    </div>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <tbody>
                                        	<?php
                                        		$order = $conn->query("SELECT COUNT(outlet) as row,outlet FROM advanceorder WHERE (orderStatus='Confirmed' OR orderStatus='Delivered') AND orderDate='$today' GROUP BY outlet");
                                        		$i=1;
                                            ...
                                            <tr>
                                                <td></td>
                                                <td><?php echo $i++?></td>
                                                <td><?php echo $order1['outlet']?></td>
                                                <td><?php echo $order1['row']?></td>
