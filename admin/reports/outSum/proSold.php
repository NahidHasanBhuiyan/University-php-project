...
<html>
<head>
<title>Bhuiyan Group | Reports | Outlet Summary | Product Sold</title>
            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left" style="background-color: #00bfff; ">
							<div class="logo-nam">
									 <h1 class="text-center" style="padding: 5px; color: #fff"><b>Product Sold</b></h1> 
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                	<div class="row">
                                		<div class="col-md-6">
                                    <h3 class="alert alert-info"><b class="text-left">Total Product Sold :</b ></h3>
                                    </div>
                                    <div class="col-md-6">
                                    		<?php
                                        	...
                                        	?>
                                    <h3 class="alert alert-info"><span class="text-right"><b>BDT <?php echo (double)$sold6['sold5']?></b></span></h3>
                                    </div>
                                    </div>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <tbody>
                                        	<?php
                                        		$sold = $conn->query("SELECT SUM(soldTotal) as sold1,soldOutlet FROM soldproduct WHERE soldStatus='Confirmed' AND soldDate='$today' GROUP BY soldOutlet ");
                                        		$i=1;
                                            ...
                                            <tr>
                                                <td></td>
                                                <td><?php echo $i++;?></td>
                                                <td><?php echo $sold2['soldOutlet']?></td>
