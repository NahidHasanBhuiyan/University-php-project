...
<html>
<head>
<title>Bhuiyan Group | Reports | Factory Wastage</title>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                	<div class="row">
                                		<div class="col-md-6">
                                    <h3 class="alert alert-danger"><b class="text-left">Total Product Wastage :</b ></h3>
                                    </div>
                                    <div class="col-md-6">
                                    					<?php
									                     ...
									                     ?>
                                    <h3 class="alert alert-danger"><span class="text-right"><b>BDT <?php echo (double)$wast['totalWas']?></b></span></h3>
                                    </div>
                                    </div>
                                </div>
                            </div>
		      ...
		      <ul id="menu" >
		        ...
		        <li><a href="#"><i class="fa fa-envelope"></i><span>Monthly Analysis</span><span class="fa fa-angle-right" style="float: right"></span></a>
		        	 <ul id="menu-academico-sub" >
			            ...
			            <li id="menu-academico-boletim" ><a href="../../../admin/monthly/othWastage.php">Other Wastage</a></li>
		             </ul>
		        </li>
