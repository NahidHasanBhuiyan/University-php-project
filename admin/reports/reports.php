...
<html>
<head>
<title>Bhuiyan Group | Admin | Reports</title>
		...
		<div class="row" style="margin-top: 100px">
			<div class="col-md-4">
				<div class="card " style="margin-top: 18px">
					<a href="ad_reports.php"><button class="card-body btn btn-warning" style="height: 190px; width: 100%"><h1><i class="fa fa-repeat fa-lg"></i></h1><h3 style="padding-top: 10px;"><b>Factory</b></h3></button></a>
				</div>
			</div>
			<div class="col-md-4">
				<div class="card " style="margin-top: 18px" >

					<a href="out_sum.php"><button class="card-body btn btn-warning" style="height: 190px; width: 100%"><h1><i class="fa fa-repeat"></i></h1><h3 style="padding-top: 10px"><b>Outlet Summary</b></h3></button></a>
				</div>
			</div>
			<div class="col-md-4">
				<div class="card " style="margin-top: 18px" >
				<a href="byout_sum.php"><button class="card-body btn btn-warning" style="height: 190px; width: 100%"><h1><i class="fa fa-repeat fa-lg"></i></h1><h3 style="padding-top: 10px"><b>By Outlet Summary</b></h3></button></a>
				</div>
			</div>
