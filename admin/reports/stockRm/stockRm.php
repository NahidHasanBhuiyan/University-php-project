...
<html>
<head>
<title>Bhuiyan Group | Reports | Factory RM Stock</title>
            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left" style="background-color: #00bfff; ">
							<div class="logo-nam">
									 <h1 class="text-center" style="padding: 5px; color: #fff"><b>Factory Stock RM</b></h1> 
                                        ...
                                        <tbody>
                                            								<?php 
									                                        	...
									                                        	<tr>
									                                        		...
									                                        		<td><?php echo $finalTaka?> <span>TK</span></td>
									                                        	</tr>
									                                        <?php endwhile;?>
									                                        <tr class="row">
									                                        <div class="col-md-6">
