...
<html>
<head>
<title>Bhuiyan Group | Reports | Factory Purchased RM</title>
            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left" style="background-color: #00bfff; ">
							<div class="logo-nam">
									 <h1 class="text-center" style="padding: 5px; color: #fff"><b>Factory Purchased RM</b></h1> 
                            ...
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                	<div class="row">
                                		<div class="col-md-6">
                                			<?php
                                				$e = $conn->query("SELECT SUM(pAmount) as d FROM rmaccount WHERE   pDate='$today'");
                                				$z = $conn->query("SELECT SUM(pAmount) as y FROM rmaccount");
                                				$h = $conn->query("SELECT SUM(pPaid) as g FROM rmaccount ");
                                				$f=$e->fetch_assoc();
		                                ...
		                                <div class="col-md-6">
		                                    <h3 class="alert alert-info"><span class="text-right"><b>BDT <?php echo (double)$toamount?> </b></span></h3>
		                                </div>
                                    </div>
                                    <div class="row">
                                		<div class="col-md-6">
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="RM Source" data-editable="false">RM Source</th>
                                                <th data-field="Amount" data-editable="false">Amount (This Month)</th>
                                                <th data-field="Paid Amount" data-editable="false">Paid Amount (This Month)</th>
                                                <th data-field="Current Due" data-editable="false">Total Due</th>
                                        ...
                                        <tbody>
                                        	<?php
                                        		$src = $conn->query("SELECT SUM(pAmount) as a,SUM(pPaid) as c,pSource FROM rmaccount WHERE pMonth='$month' GROUP BY pSource");
                                        		$j=1;
                                        		while($srcName = $src->fetch_assoc()):
                                        			$srcName1 = $srcName['pSource'];
                                        			$ph = $conn->query("SELECT srcPhone FROM crsrc WHERE srcName='$srcName1'");
                                        			$phone = $ph->fetch_assoc();

                                        			$e = $conn->query("SELECT SUM(pAmount) as d FROM rmaccount WHERE  pSource='$srcName1' AND pMonth='$month'");
                                        			$ee = $conn->query("SELECT SUM(pPaid) as paid FROM rmaccount WHERE  pSource='$srcName1' AND pMonth='$month' ");
                                				$z = $conn->query("SELECT SUM(pAmount) as y FROM rmaccount WHERE  pSource='$srcName1' ");
                                				$h = $conn->query("SELECT SUM(pPaid) as g FROM rmaccount WHERE  pSource='$srcName1'");
                                				$f=$e->fetch_assoc();
                                				$eee= $ee->fetch_assoc();
                                            ...
                                            <tr>
                                                <td></td>
                                                <td><?php echo $j++;?></td>
                                                <td class="text-capitalize"><?php echo $srcName1?></td>
                                                <td><?php echo $toamount?> <span>TK</span></td>
                                                <td><?php echo $paid?> <span>TK</span></td>
                                                <td><?php echo $due  ?> <span>TK</span></td>
                                                <td><?php echo $phone['srcPhone']?></td>
                            ...
                            <div class="panel-group adminpro-custon-design" id="accordion">
                                ...
                                <div class="panel panel-danger">
                                    <div class="panel-heading accordion-head">
									 ...
									 Click here to view full RM Purchase Report Item-wise submitted by the Factory Today! </a>
                                        </h4>
                                    </div>
								                                        ...
								                                        <tbody>
																			 ...
																			 <?php 
																				...
																				<tr >
												                                    ...
												                                    <td class="text-capitalize"><?php echo $fpur['pRmSrcName']?></td>
