...
<html>
<head>
<title>Bhuiyan Group | Reports | Factory Production</title>
            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left" style="background-color: #00bfff; ">
							<div class="logo-nam">
									 <h1 class="text-center" style="padding: 5px; color: #fff"><b>Factory Production</b></h1> 
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                	<div class="row">
                                		<div class="col-md-6">
		                                    <h3 class="alert alert-info"><b class="text-left">Today Total Production :</b ></h3>
		                                    </div>
		                                <div class="col-md-6">
		                                				<?php
									                	...
									                	?>
		                                    <h3 class="alert alert-info"><span class="text-right"><b>BDT <?php echo (double)$madeTotal['madeTotal']?></b></span></h3>
		                                </div>
                                    </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="Product Category" data-editable="false">Product Category</th>
                                                <th data-field="Value" data-editable="false">Value (BDT)</th>
                                        ...
                                        <tbody>
                                        	<?php
                                        		$cat1 = $conn->query("SELECT SUM(totalPrice) AS price,proCat FROM madeproduct WHERE madePrDate='$today' GROUP BY proCat");
                                        		$i=1;
                                        		while($cat2=$cat1->fetch_assoc()):

                                        	?>
                                            <tr>
                                                <td></td>
                                                <td><?php echo $i++;?></td>
                                                <td><?php echo $cat2['proCat']?></td>
                                                <td><?php echo $cat2['price']?></td>
                            ...
                            <div class="panel-group adminpro-custon-design" id="accordion">
                                ...
                                <div class="panel panel-warning">
                                    <div class="panel-heading accordion-head">
									 ...
									 Click here to view full Production Report Item-wise submitted by the Factory Today!  </a>
                                        </h4>
                                    </div>
