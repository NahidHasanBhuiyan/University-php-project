...
<html>
<head>
<title>Bhuiyan Group | Reports | Product Distribution</title>
            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left" style="background-color: #00bfff; ">
							<div class="logo-nam">
									 <h1 class="text-center" style="padding: 5px; color: #fff"><b>Product Distribution</b></h1> 
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                	<div class="row">
                                		<div class="col-md-6">
		                                    <h3 class="alert alert-info"><b class="text-left">Outlet to Outlet  Transfer :</b ></h3>
		                                    </div>
		                                <div class="col-md-6">
		                                	<?php
		                                	...
		                                	?>
		                                    <h3 class="alert alert-info"><span class="text-right"><b>BDT <?php echo (double)$distrib;?></b></span></h3>
		                                </div>
                                    </div>
                                    <div class="row">
                                		<div class="col-md-6">
		                                    <h3 class="alert alert-warning"><b class="text-left">Total Production Value :</b ></h3>
		                                 </div>
		                                <div class="col-md-6">
		                                	<?php
		                                		$made = $conn->query("SELECT SUM(totalPrice) as proMade FROM madeproduct WHERE madePrDate='$today' AND madePrStatus='Confirmed'");
		                                		$madePr = $made->fetch_assoc();
		                                		$madeProDuc = $madePr['proMade'];

		                                	?>
		                                    <h3 class="alert alert-warning"><span class="text-right"><b>BDT <?php echo (double)$madeProDuc;?></b></span></h3>
		                                </div>
                                    </div>
                                    <div class="row">
                                		<div class="col-md-6">
		                                    <h3 class="alert alert-warning"><b class="text-left">Total Distribution Value :</b ></h3>
		                                 </div>
		                                <div class="col-md-6">
		                                	<?php
		                                		$distF = $conn->query("SELECT SUM(distTotalPrice) as distributeF FROM productdistribution WHERE prDistDate='$today' AND outletStatus='Confirmed' ");
		                                		$distriF = $distF->fetch_assoc();
		                                		$distribF = $distriF['distributeF'];
		                                		$gap = $madeProDuc-$distribF;

		                                	?>
		                                    <h3 class="alert alert-warning"><span class="text-right"><b>BDT <?php echo (double)$distribF;?></b></span></h3>
		                                </div>
                                    </div>
                                    <div class="row">
                                		<div class="col-md-6">
		                                    <h3 class="alert alert-danger"><b class="text-left">Production Vs Distribution Gap :</b ></h3>
		                                 </div>
		                                <div class="col-md-6">
		                                    <h3 class="alert alert-danger"><span class="text-right"><b>BDT <?php echo (double)$gap?></b></span></h3>
		                                </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="Outlet" data-editable="false">Outlet</th>
                                                <?php 
                                                	$catName1 = $conn->query("SELECT prCategoryName FROM category ");
                                                	while($catName2=$catName1->fetch_assoc()):
                                                ?>
                                                <th data-field="<?php echo $catName2['prCategoryName']?>" data-editable="false"><?php echo $catName2['prCategoryName']?></th>
                                                <?php endwhile;?>
                                        ...
                                        <tbody>
                                        	<?php
                                        		$outle1 = $conn->query("SELECT * FROM productdistribution WHERE outletStatus='Confirmed' AND prDistDate='$today' GROUP BY prDistOutleName");
                                        		while($outle2 = $outle1->fetch_assoc()):
                                        			$outlet11 = $outle2['prDistOutleName'];
                                        	?>
                                            <tr>
                                                <td></td>
                                                <td>1</td>
                                                <td class="text-capitalize"><?php echo $outlet11;?></td>
                                                <?php
                                                	$catName3 = $conn->query("SELECT prCategoryName FROM category ");
                                                	while($catName4=$catName3->fetch_assoc()):
                                                		$category5 = $catName4['prCategoryName'];
                                                		$sum1 = $conn->query("SELECT SUM(distTotalPrice) as sum2 FROM productdistribution WHERE catName='$category5' AND prDistOutleName='$outlet11' AND prDistDate='$today' AND outletStatus='Confirmed'");
                                                		$sum3 = $sum1->fetch_assoc();
                                                		$sum4 = $sum3['sum2'];
                                                ?>
                                                <td><?php echo $sum4?></td>
                                                <?php endwhile;?>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="admin-pro-accordion-wrap responsive-mg-b-30">
                            ...
                            <div class="panel-group adminpro-custon-design" id="accordion">
                                <?php
                                	$outlet111 = $conn->query("SELECT outName,sl FROM croutlet");
                                	while($outlet222=$outlet111->fetch_assoc()):
                                		$outlet333 = $outlet222['outName'];
                                ?>
                                <div class="panel panel-danger">
                                    <div class="panel-heading accordion-head">
                                        <h4 class="panel-title text-center">
                                            <a data-toggle="collapse" data-parent="#accordion" href="#<?php echo $outlet222['sl']?>">
									 			<span class="badge text-capitalize" > <?php echo $outlet333 ;?></span>Click to view item-wise distribution report</a>
                                        </h4>
                                    </div>
                                    <div id="<?php echo $outlet222['sl']?>" class="panel-collapse panel-ic collapse">
									                            ...
									                            <div class="sparkline13-graph">
									                                <div class="datatable-dashv1-list custom-datatable-overright">
									                                    ...
									                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
									                                        ...
									                                        <tbody>
									                                			<?php
									                                				$report = $conn->query("SELECT prDistPrName,SUM(prDistQuantity) as report1,prDistUnit,SUM(distTotalPrice) as report2,distPerUnitPrice,prDistUnit FROM productdistribution WHERE prDistOutleName='$outlet333' AND outletStatus='Confirmed' AND prDistDate='$today' GROUP BY prDistPrName");
									                                				while($report3=$report->fetch_assoc()):
									                                			?>
												                                <tr>
												                                    <td></td>
												                                    <td>1</td>
												                                    
												                                    <td><?php echo $report3['prDistPrName']?></td>
												                                    <td><?php echo $report3['report1']?></td>
												                                    <td><?php echo $report3['prDistUnit']?></td>
												                                    <td><?php echo $report3['distPerUnitPrice']?></td>
												                                    <td><?php echo $report3['report2']?></td>
