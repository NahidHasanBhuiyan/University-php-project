...
<html>
<head>
<title>Bhuiyan Group | Reports | Factory Used RM</title>
            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left" style="background-color: #00bfff; ">
							<div class="logo-nam">
									 <h1 class="text-center" style="padding: 5px; color: #fff"><b>Factory Used RM</b></h1> 
                                ...
                                <div class="main-sparkline13-hd">
                                	<div class="row">
                                		<div class="col-md-6">
									                	...
									                	?>
                                    <h3 class="alert alert-info"><b class="text-left">Used Row Material :</b ></h3>
                                    </div>
                                    <div class="col-md-6">
                                    <h3 class="alert alert-info"><span class="text-right"><b>BDT <?php echo (double)$usedRmTotal['usedRmTotal']?></b></span></h3>
                                    </div>
                                    </div>
                                </div>
                            </div>
