...
<html>
<head>
<title>Bhuiyan Group | Create | Outlet Fix Expense</title>
            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left" style="background-color: #00bfff; ">
							<div class="logo-nam">
									 <h1 class="text-center" style="padding: 5px; color: #fff"><b>Outlet Fix Exp.</b></h1> 
							...
							<div class="panel panel-success">
                                ...
                                <div class="panel panel-success" style="margin-top: 10px">
                                	<?php
                                		...
                                		if(isset($_POST['addoFixedExp'])){
                                			$outfixedExpOutlet = $_POST['outfixedExpOutlet'];
                                			$outfixedExpName = $_POST['outfixedExpName'];
                                			$outfixedExpDetails = $_POST['outfixedExpDetails'];
                                			$foutfixedExpAmount = $_POST['foutfixedExpAmount'];
                                			$outfixedExpType = $_POST['outfixedExpType'];

                                			
                                			
                                			if(empty($outfixedExpOutlet) || empty($outfixedExpName) || empty($outfixedExpDetails) || empty($foutfixedExpAmount) || empty($outfixedExpType)){
											$message = "<p class='alert alert-danger'>Field Must Not Be Empty</p>";

											}else{
											$conn->query("INSERT INTO outfixedexpense(outfixedExpOutlet,outfixedExpName,outfixedExpDetails,foutfixedExpAmount,outfixedExpType,dFrom,day,dMonth) VALUES ('$outfixedExpOutlet','$outfixedExpName','$outfixedExpDetails','$foutfixedExpAmount','$outfixedExpType','$today','$day','$month')");
											$message = "<p class='alert alert-success'>Successfully added Fixed Expense!</p>";
											}
											echo $message;
                                		}
								...
								<form action="" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="div">
                                                	<h3 class="alert alert-danger">Daily Fixed Expense</h3>
                                                </div>
                                                    <div class="chosen-select-single mg-b-20" style="margin-top: 8px;">
		                                                ...
		                                                <select name="outfixedExpOutlet" class="chosen-select" tabindex="-1">
                                                    ...
                                                    <div class="form-group" style="margin-top: 8px;">
                                                        ...
                                                        <input name="outfixedExpName" type="text" class="form-control" placeholder="Ex: Buying Paper">
                                                    </div>
                                                    <div class="form-group" style="margin-top: 8px;">
                                                    	<label for=""><i class="fa fa-cog" aria-hidden="true"></i> Details</label>
                                                        
                                                        <input name="outfixedExpDetails" type="text" class="form-control" placeholder="Ex: Finance Report Book">
                                                    </div>
                                                    <div class="form-group" style="margin-top: 8px;">
                                                    	<label for=""><i class="fa fa-money" aria-hidden="true"></i> Amount(BDT)</label>
                                                        
                                                        <input name="foutfixedExpAmount" type="text" class="form-control" placeholder="Ex: 200">
                                                    </div>
                                                    
		                                            <div class="chosen-select-single mg-b-20" style="margin-top: 8px;">
		                                                <label><i class="fa fa-list" aria-hidden="true"></i> Expense Type</label>
		                                                <select name="outfixedExpType" class="chosen-select" tabindex="-1">
																<option value="">Select</option>
																<?php
                                        ...
                                        <div class="row" style="margin-top: 8px">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center mg-b-pro-edt custom-pro-edt-ds">
                                                    <input name="addoFixedExp" type="submit" value="Add Fixed Expense" class="btn btn-danger">
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h3 class="alert alert-danger"><b>Daily Fix Expense List</b></h3>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="Amount(TK)" data-editable="false">Amount(TK)</th>
                                                <th data-field="From" data-editable="false">From</th>
                                                <th data-field="To" data-editable="false">To</th>
                                        ...
                                        <tbody>
                                            <?php
                                        		$exp = $conn-> query("SELECT * FROM outfixedexpense WHERE dMonth='$month' ORDER BY sl DESC");
                                        		$i=1;
                                        		$sum=0;
                                        		while($expense = $exp->fetch_assoc()):
                                        			$nextday = (int)$day+1;
                                        			 $aaa = (int)$expense['day'];
                                        			 $different = $nextday-$aaa;
                                        			 $total = $expense['foutfixedExpAmount'];
                                        			 $dTotal = $different*$total;
                                        			$sum=$sum+$dTotal;
                                        	?>
                                            <tr>
                                                <td></td>
                                                <td><?php echo $i++;?></td>
                                                <td class="text-capitalize"><?php echo $expense['outfixedExpOutlet']?></td>
                                                <td class="text-capitalize"><?php echo $expense['outfixedExpName']?></td>
                                                <td class="text-capitalize"><?php echo $expense['outfixedExpDetails']?></td>
                                                <td class="text-capitalize"><?php echo $expense['foutfixedExpAmount']?></td>
                                                <td class="text-capitalize"><?php echo $expense['dFrom']?></td>
                                                <td class="text-capitalize"><?php echo $today?></td>
                                                <td class="text-capitalize"><?php echo $dTotal?></td>
                                                <td class="text-capitalize"><?php echo $expense['outfixedExpType']?></td>
                                               
												
                                                <td>
			                                        
			                                        <a onclick="javascript: return confirm('Please Confirm Delation');" href="deleteFixExp.php?sl=<?php echo $expense['sl']?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
			                                    </td>
                                            </tr>
                                            <?php endwhile;?>
                                        </tbody>
                                       										 <div class="col-md-6">
														                		<h4 class="alert bg-success"><b>Expense:</b></h4>
														                	</div>
														                	<div class="col-md-6">
