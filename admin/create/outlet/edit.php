		...
		<p class="alert bg-success text-right">Date: <?php echo $date?></p>
							...
							<?php
								...
								if(isset($_POST['update'])){
									$updateOutName = $_POST['updateOutName'];
									$updateOutPhone = $_POST['updateOutPhone'];
									$updateOutAddress = $_POST['updateOutAddress'];
									$updateOutUser = $_POST['updateOutUser'];
									$updateOutPass = $_POST['updateOutPass'];
									$updateTaxUser = $_POST['updateTaxUser'];
									$updateTaxPass = $_POST['updateTaxPass'];
									
									



									if(empty($updateOutName) || empty($updateOutPhone) || empty($updateOutAddress) || empty($updateOutUser) || empty($updateOutPass) || empty($updateTaxUser) || empty($updateTaxPass)){
										$message = "<p class='alert alert-danger'>Field Must Not Be Empty! <a href='crOutlet.php'>Go to Back Page</a></p>";

									}else{

										$conn-> query("UPDATE croutlet SET outName='$updateOutName' , outAddress='$updateOutAddress' , outPhone='$updateOutAddress',outUser='$updateOutUser',outPass='$updateOutPass',taxUser='$updateTaxUser',taxPass='$updateTaxPass' WHERE sl= '$sl'");
											$message = "<p class='alert alert-warning'>Successfully Update! <a href='crOutlet.php'>Go to Back Page</a></p>";
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <?php 
													...
													$aaa = $conn-> query("SELECT * FROM croutlet WHERE sl='$sl'");
                                                ...
                                                ?>
                                                    ...
                                                    <div class="form-group" style="margin-top: 8px;">
                                                        ...
                                                        <input name="updateOutName" value="<?php echo $update['outName']?>" type="text" class="form-control" placeholder="Enter Outlet Name">
                                                    </div>
                                                    <div class="form-group" style="margin-top: 8px;">
                                                    	<label for=""><i class="fa fa-phone" aria-hidden="true"></i> Phone Number <span style="color:red">*</span></label>
                                                        
                                                        <input name="updateOutPhone" value="<?php echo $update['outPhone']?>" type="text" class="form-control" placeholder="Enter Outlet Phone Number">
                                                    </div>
                                                    <div class="form-group" style="margin-top: 8px;">
                                                    	<label for=""><i class="fa fa-home" aria-hidden="true"></i> Address <span style="color:red">*</span></label>
                                                        
                                                        <input name="updateOutAddress" value="<?php echo $update['outAddress']?>" type="text" class="form-control" placeholder="Enter Outlet Address">
                                                    </div>
                                                    <div class="form-group" style="margin-top: 8px;">
                                                    	<label for=""><i class="fa fa-user" aria-hidden="true"></i> User Id <span style="color:red">*</span></label>
                                                        
                                                        <input name="updateOutUser" value="<?php echo $update['outUser']?>" type="text" class="form-control" placeholder="Create Unique User Id">
                                                    </div>
                                                    ...
                                                    <div class="sparkline12-graph">
						                                <div id="pwd-container1">
						                                    <div class="form-group">
						                                        ...
						                                        <input name="updateOutPass" value="<?php echo $update['outPass']?>" type="text" class="form-control example1" id="password1" placeholder="Password">
						                                    </div>
						                                    <div class="form-group">
						                            ...
						                            <div class="form-group" style="margin-top: 8px;">
                                                        ...
                                                        <input name="updateTaxUser" value="<?php echo $update['taxUser']?>" type="text" class="form-control" placeholder="Create User Id">
                                                    </div>
                                                    <div class="form-group" style="margin-top: 8px;">
                                                    	<label for=""><i class="fa fa-lock" aria-hidden="true"></i> Tax Pass <span style="color:red">*</span></label>
                                                        
                                                        <input name="updateTaxPass" value="<?php echo $update['taxPass']?>" type="text" class="form-control" placeholder="Create Password">
                                                    </div>
