...
<html>
<head>
<title>Bhuiyan Group | Create | Factory Non Fix Expense</title>
            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left" style="background-color: #00bfff; ">
							<div class="logo-nam">
									 <h1 class="text-center" style="padding: 5px; color: #fff"><b>Factory Non Fix Exp.</b></h1> 
							...
							<div class="panel panel-success">
                                 ...
                                 <div class="panel panel-success" style="margin-top: 10px">
                                	<?php
                                		...
                                		if(isset($_POST['addnonFixedExp'])){
                                			$nonfixedExpName = $_POST['nonfixedExpName'];
                                			$nonfixedExpDetails = $_POST['nonfixedExpDetails'];
                                			$nonfixedExpAmount = $_POST['nonfixedExpAmount'];
                                			$nonfixedExpNotes = $_POST['nonfixedExpNotes'];
                                			$nonfixedExpType = $_POST['nonfixedExpType'];

                                			
                                			
                                			if(empty($nonfixedExpName) || empty($nonfixedExpDetails) || empty($nonfixedExpAmount) || empty($nonfixedExpAmount) || empty($nonfixedExpType)){
											$message = "<p class='alert alert-danger'>Field Must Not Be Empty</p>";

											}else{
											$conn->query("INSERT INTO nonfixedexpense(nonfixedExpName,nonfixedExpDetails,nonfixedExpAmount,nonfixedExpNotes,nonfixedExpType,nonMonth) VALUES('$nonfixedExpName','$nonfixedExpDetails','$nonfixedExpAmount','$nonfixedExpNotes','$nonfixedExpType','$month')");
								...
								<form action="" method="POST">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="div">
                                                    ...
                                                    <div class="form-group" style="margin-top: 8px;">
                                                        ...
                                                        <input name="nonfixedExpName" type="text" class="form-control" placeholder="Ex: Buying Paper">
                                                    </div>
                                                    <div class="form-group" style="margin-top: 8px;">
                                                    	<label for=""><i class="fa fa-cog" aria-hidden="true"></i> Details</label>
                                                        
                                                        <input name="nonfixedExpDetails" type="text" class="form-control" placeholder="Ex: Finance Report Book">
                                                    </div>
                                                    <div class="form-group" style="margin-top: 8px;">
                                                    	<label for=""><i class="fa fa-money" aria-hidden="true"></i> Amount(BDT)</label>
                                                        
                                                        <input name="nonfixedExpAmount" type="text" class="form-control" placeholder="Ex: 200">
                                                    </div>
                                                    <div class="form-group" style="margin-top: 8px;">
                                                    	<label for=""><i class="fa fa-envelope" aria-hidden="true"></i> Notes</label>
                                                        
                                                        <input type="text" name="nonfixedExpNotes" class="form-control" placeholder="Ex: For the purpose of factory finance report">
                                                    </div>
		                                            <div class="chosen-select-single mg-b-20" style="margin-top: 8px;">
		                                                ...
		                                                <select name="nonfixedExpType" class="chosen-select" tabindex="-1">
                                        ...
                                        <div class="row" style="margin-top: 8px">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center mg-b-pro-edt custom-pro-edt-ds">
                                                    <input name="addnonFixedExp" type="submit" value="Add Fixed Expense" class="btn btn-danger">
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h3 class="alert alert-danger"><b>Non Fix Expense List</b></h3>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <tbody>
                                           <?php
                                        		$exp = $conn-> query("SELECT * FROM nonfixedexpense WHERE nonMonth='$month' ORDER BY sl DESC");
                                        		$i=1;
                                        		$sum=0;
                                        		while($expense = $exp->fetch_assoc()):
                                        			$sum=$sum+$expense['nonfixedExpAmount'];

                                        	?>
                                            <tr>
                                                <td></td>
                                                <td><?php echo $i++;?></td>
                                                <td class="text-capitalize"><?php echo $expense['nonfixedExpName']?></td>
                                                <td class="text-capitalize"><?php echo $expense['nonfixedExpDetails']?></td>
                                                <td class="text-capitalize"><?php echo $expense['nonfixedExpAmount']?></td>
                                                <td class="text-capitalize"><?php echo $expense['nonfixedExpNotes']?></td>
                                                <td class="text-capitalize"><?php echo $expense['nonfixedExpType']?></td>
