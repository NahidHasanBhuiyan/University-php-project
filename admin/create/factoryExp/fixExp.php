...
<html>
<head>
<title>Bhuiyan Group | Create | Factory Fix Expense</title>
            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left" style="background-color: #00bfff; ">
							<div class="logo-nam">
									 <h1 class="text-center" style="padding: 5px; color: #fff"><b>Factory Fix Exp.</b></h1> 
		...
		<p class="alert bg-info text-right">Date: <?php echo $date?></p>
                                ...
                                <div class="panel panel-success" style="margin-top: 10px">
                                	<?php
                                		...
                                		if(isset($_POST['addFixedExp'])){
                                			$fixedExpName = $_POST['fixedExpName'];
                                			$fixedExpDetails = $_POST['fixedExpDetails'];
                                			$fixedExpAmount = $_POST['fixedExpAmount'];
                                			$fixedExpType = $_POST['fixedExpType'];

                                			
                                			
                                			if(empty($fixedExpName) || empty($fixedExpDetails) || empty($fixedExpAmount) || empty($fixedExpType)){
											$message = "<p class='alert alert-danger'>Field Must Not Be Empty</p>";

											}else{
											$conn->query("INSERT INTO fixedexpense(fixedExpName,fixedExpDetails,fixedExpAmount,fixedExpType,dFrom,dMonth,day) VALUES('$fixedExpName','$fixedExpDetails','$fixedExpAmount','$fixedExpType','$today','$month','$day')");
								...
								<form action="" method="POST">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="div">
                                                    ...
                                                    <div class="form-group" style="margin-top: 8px;">
                                                        ...
                                                        <input name="fixedExpName" type="text" class="form-control" placeholder="Ex: Buying Paper">
                                                    </div>
                                                    <div class="form-group" style="margin-top: 8px;">
                                                    	<label for=""><i class="fa fa-cog" aria-hidden="true"></i> Details</label>
                                                        
                                                        <input name="fixedExpDetails" type="text" class="form-control" placeholder="Ex: Finance Report Book">
                                                    </div>
                                                    <div class="form-group" style="margin-top: 8px;">
                                                    	<label for=""><i class="fa fa-money" aria-hidden="true"></i> Amount(BDT)</label>
                                                        
                                                        <input name="fixedExpAmount" type="text" class="form-control" placeholder="Ex: 200">
                                                    </div>
		                                            ...
		                                            <div class="chosen-select-single mg-b-20" style="margin-top: 8px;">
		                                                ...
		                                                <select name="fixedExpType" class="chosen-select" tabindex="-1">
                                        ...
                                        <div class="row" style="margin-top: 8px">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center mg-b-pro-edt custom-pro-edt-ds">
                                                    <input name="addFixedExp" type="submit" value="Add Fixed Expense" class="btn btn-danger">
                            ...
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <tbody>
                                            <?php
                                        		$exp = $conn-> query("SELECT * FROM fixedexpense WHERE dMonth='$month' ORDER BY sl DESC");
                                        		$i=1;
                                        		$sum = 0;
                                            ...
                                            <tr>
                                                <td></td>
                                                <td><?php echo $i++;?></td>
                                                <td class="text-capitalize"><?php echo $expense['fixedExpName']?></td>
                                                <td class="text-capitalize"><?php echo $expense['fixedExpDetails']?></td>
                                                <td class="text-capitalize"><?php echo $expense['fixedExpAmount']?></td>
                                                ...
                                                <td class="text-capitalize"><?php echo $expense['fixedExpType']?></td>
                                               
												
                                                <td>
			                                        <a onclick="javascript: return confirm('Please Confirm Edit');" href="editFixExp.php?sl=<?php echo $expense['sl']?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
