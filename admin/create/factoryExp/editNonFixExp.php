...
<html>
<head>
<title>Bhuiyan Group | Create | Update Non Fixed Expense</title>
            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left" style="background-color: #00bfff; ">
							<div class="logo-nam">
									 <h1 class="text-center" style="padding: 5px; color: #fff"><b>Update Non Fix Exp.</b></h1> 
		...
		<p class="alert bg-success text-right">Date: <?php echo $date?></p>
							...
							<?php
								...
								if(isset($_POST['update'])){
											$unonfixedExpName = $_POST['unonfixedExpName'];
                                			$unonfixedExpDetails = $_POST['unonfixedExpDetails'];
                                			$unonfixedExpAmount = $_POST['unonfixedExpAmount'];
                                			$unonfixedExpNotes = $_POST['unonfixedExpNotes'];
                                			$unonfixedExpType = $_POST['unonfixedExpType'];
									



									if(empty($unonfixedExpName) || empty($unonfixedExpDetails) || empty($unonfixedExpAmount) || empty($unonfixedExpNotes) || empty($unonfixedExpType) ){
										$message = "<p class='alert alert-danger'>Field Must Not Be Empty! <a href='nonFixExp.php'>Go to Back Page</a></p>";

									}else{

										$conn-> query("UPDATE nonfixedexpense SET nonfixedExpName='$ufixedExpName' , nonfixedExpDetails='$ufixedExpDetails' , nonfixedExpAmount='$ufixedExpAmount', nonfixedExpNotes='$ufixedExpNotes',nonfixedExpType='$ufixedExpType' WHERE sl= '$sl'");
											$message = "<p class='alert alert-warning'>Successfully Update! <a href='nonFixExp.php'>Go to Back Page</a></p>";
                                     ...
                                     ?>
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="div">
                                                	<h3 class="alert alert-danger">Update Non Fixed Expense</h3>
                                                </div>
                                                    ...
                                                    <div class="form-group" style="margin-top: 8px;">
                                                        ...
                                                        <input type="text" name="unonfixedExpNotes" class="form-control" placeholder="Ex: For the purpose of factory finance report">
                                                    </div>
