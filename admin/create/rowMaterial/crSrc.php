...
<html>
<head>
<title>Bhuiyan Group | Reports | Add Source</title>
            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left" style="background-color: #00bfff; ">
							<div class="logo-nam">
									 <h1 class="text-center" style="padding: 5px; color: #fff"><b>Create RM Source</b></h1> 
	 ...
	 <div class="container-fluid" >
		<p class="alert bg-info text-right">Date: <?php echo $date?></p>
							...
							<?php
								...
								if(isset($_POST['addSrc'])){
									$src = $_POST['src'];
									$srcName = $_POST['srcName'];
									$srcPhone = $_POST['srcPhone'];
									
									
									if(empty($src) || empty($srcName) || empty($srcPhone) ){
										$message = "<p class='alert alert-danger'>Field Must Not Be Empty</p>";

									}else{
										$conn-> query("INSERT INTO crsrc (src,srcName,srcPhone) VALUES ('$src','$srcName','$srcPhone')");
										$message = "<p class='alert alert-success'>Successfully added Source!</p>";
									}
									echo $message;
								}
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    ...
                                                    <div class="form-group" style="margin-top: 8px;">
                                                    	<label for=""><i class="fa fa-pencil" aria-hidden="true"></i> Source</label>
                                                        
                                                        <input name="src" type="text" class="form-control" placeholder="Ex: Fresh">
                                                    </div>
                                                    <div class="form-group" style="margin-top: 8px;">
                                                    	<label for=""><i class="fa fa-user" aria-hidden="true"></i> Source Name</label>
                                                        
                                                        <input name="srcName" type="text" class="form-control" placeholder="Ex: Ahad Quaraishi">
                                                    </div>
                                                    <div class="form-group" style="margin-top: 8px;">
                                                    	<label for=""><i class="fa fa-phone" aria-hidden="true"></i> Source Cell</label>
                                                        
                                                        <input name="srcPhone" type="text" class="form-control" placeholder="Ex: 01711111111">
                                                    </div>
                                        ...
                                        <div class="row" style="margin-top: 8px">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center mg-b-pro-edt custom-pro-edt-ds">
														...
														<input name="addSrc" type="submit" class="btn btn-success" value="Add Source">
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h3 class="alert alert-info"><b>Row Material Purchase Source</b></h3>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="Source name" data-editable="false">Source Name</th>
                                                <th data-field="Source Cell" data-editable="false">Source Cell</th>
                                        ...
                                        <tbody>
                                        	<?php
                                        		...
                                        		$ddd  = $conn->query("SELECT * FROM crsrc");
                                        		$i=1;
                                        		while($crsrc= $ddd-> fetch_assoc()):
                                            ...
                                            <tr>
                                                <td></td>
                                                <td><?php echo $i++;?></td>
                                                <td><?php echo $crsrc['src']?></td>
                                                <td><?php echo $crsrc['srcName']?></td>
                                                <td><?php echo $crsrc['srcPhone']?></td>
												
                                                <td>
			                                        
			                                        <a onclick="javascript: return confirm('Please Confirm Delation');" href="deleteSrc.php?sl=<?php echo $crsrc['sl']?>"><button data-toggle="tooltip" title="Delete" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
			                                    </td>
                                            </tr>
                                            <?php endwhile;?>
