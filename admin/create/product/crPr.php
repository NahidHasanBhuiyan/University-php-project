...
<html>
<head>
<title>Bhuiyan Group | Create | Add Product</title>
            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left" style="background-color: #00bfff; ">
							<div class="logo-nam">
									 <h1 class="text-center" style="padding: 5px; color: #fff"><b>Create Product</b></h1> 
							...
							<div class="panel panel-success">
								<?php
									if(isset($_POST['addCategory'])){
										...
										$message = "<p class='alert alert-danger'>Field Must Not Be Empty</p>";
											...
											$conn-> query("INSERT INTO category(prCategoryName) VALUES ('$categoryName')");
											$message = "<p class='alert alert-success'>Successfully added Category!</p>";
										}
										echo $message;
								...
								<form action="" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="div">
                                                	<h3 class="alert alert-success">Add Product Category</h3>
                                                </div>
                                                    
                                                    <div class="form-group" style="margin-top: 8px;">
                                                    	<label for=""><i class="fa fa-list" aria-hidden="true"></i> Category Name</label>
                                                        
                                                        <input name="categoryName" type="text" class="form-control" placeholder="Ex: Toast">
                                                    </div>
                                ...
                                <div class="panel panel-success" style="margin-top: 10px">
                                	<?php
                                    	if(isset($_POST['addProduct'])){
                                    		...
                                    		$prUnit = $_POST['prUnit'];
                                    		$prFixedPrice = $_POST['prFixedPrice'];
                                    		$categoryName = $_POST['categoryName'];

                                    		

                                    		if(empty($prName) || empty($prQuantity) || empty($prUnit) || empty($prFixedPrice) || empty($categoryName)){
											$message = "<p class='alert alert-danger'>Field Must Not Be Empty</p>";

											}else{
											$conn-> query("INSERT INTO product(prName,prQuantity,prUnit,prFixedPrice,categoryName) VALUES('$prName','$prQuantity','$prUnit','$prFixedPrice','$categoryName')");
											$message = "<p class='alert alert-success'>Successfully added Product!</p>";
											}
											echo $message;
                                    	}
								...
								<form action="" method="POST">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="div">
                                                    ...
                                                    <div class="form-group" style="margin-top: 8px;">
                                                        ...
                                                        <input name="prName" type="text" class="form-control" placeholder="Ex: Dry Cake">
                                                    </div>
                                                    <div class="form-group" style="margin-top: 8px;">
                                                    	<label for=""><i class="fa fa-calculator" aria-hidden="true"></i> Quantity</label>
                                                        
                                                        <input name="prQuantity" type="text" class="form-control" placeholder="Ex: 2">
                                                    </div>
                                                    ...
                                                    <div class="chosen-select-single mg-b-20" style="margin-top: 8px;">
		                                                ...
		                                                <select name="prUnit" class="chosen-select" tabindex="-1">
                                                    ...
                                                    <div class="form-group" style="margin-top: 8px;">
                                                        ...
                                                        <input name="prFixedPrice" type="text" class="form-control" placeholder="Ex: 200">
                                                    </div>
                                                    
                                                    <div class="chosen-select-single mg-b-20" style="margin-top: 8px;">
		                                                <label><i class="fa fa-list" aria-hidden="true"></i> Category</label>
		                                                <select name="categoryName" class="chosen-select" tabindex="-1">
																<option value="">Select</option>
																<?php
                                        ...
                                        <div class="row" style="margin-top: 8px">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center mg-b-pro-edt custom-pro-edt-ds">
                                                     <input name="addProduct" type="submit" value="Add Product" class="btn btn-success">
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h3 class="alert alert-info"><b>Products List</b></h3>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="Product Quantity" data-editable="false">Quantity</th>
                                                <th data-field="RM Name" data-editable="false">Unit</th>
                                                <th data-field="Quantity" data-editable="false">Fix Price Value(BDT)</th>
                                                <th data-field="Unit" data-editable="false">Category</th>
                                                <th data-field="action">Action</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        	<?php
                                        		$pro = $conn-> query("SELECT * FROM product ORDER BY sl DESC");
                                        		$i=1;
                                            ...
                                            <tr>
                                                <td></td>
                                                <td><?php echo $i++;?></td>
                                                <td class="text-capitalize"><?php echo $product['prName']?></td>
                                                <td class="text-capitalize"><?php echo $product['prQuantity']?></td>
                                                <td class="text-capitalize"><?php echo $product['prUnit']?></td>
                                                <td class="text-capitalize"><?php echo $product['prFixedPrice']?></td>
                                                <td class="text-capitalize"><?php echo $product['categoryName']?></td>
												
                                                <td>
			                                        <a onclick="javascript: return confirm('Please Confirm Edit');" href="edit.php?sl=<?php echo $product['sl']?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
			                                        <a onclick="javascript: return confirm('Please Confirm Delation');" href="delete.php?sl=<?php echo $product['sl']?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
			                                    </td>
                                            </tr>
                                            <?php endwhile;?>
