            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left" style="background-color: #00bfff; ">
							<div class="logo-nam">
									 <h1 class="text-center" style="padding: 5px; color: #fff"><b>Monthly Analysis</b></h1> 
			...
			<div class="row">
				<div class="col-md-4">
					<div class="card">
						...
						<a href="sell.php"><button class="card-body btn btn-success" style="height:150px; width: 100%"><h1><i class="fa fa-list-alt"></i></h1><br><h3><b>Sell Graph By Outlet</b></h3></button></a>
    			...
    			<div class="col-md-4">
					<div class="card">
						<div class="card-body " style="margin-top: 18px">
						<a href="distGap.php"><button class="card-body btn btn-danger" style="height:150px; width: 100%"><h1><i class="fa fa-list-alt"></i></h1><br><h3 style="padding-top: 10px;"><b>RM Purchase</b></h3></button></a>
    			...
    			<div class="col-md-4">
					<div class="card">
						<div class="card-body " style="margin-top: 18px">
						<a href="mismatch.php"><button class="card-body btn btn-danger" style="height:150px; width: 100%"><h1><i class="fa fa-list-alt"></i></h1><br><h3 style="padding-top: 10px;"><b>Distribution Mismatch</b></h3></button></a>
    			...
    			<div class="col-md-4">
					<div class="card">
						<div class="card-body " style="margin-top: 18px">
						<a href="facWastage.php"><button class="card-body btn btn-danger" style="height:150px; width: 100%"><h1><i class="fa fa-list-alt"></i></h1><br><h3 style="padding-top: 10px;"><b>Factory Wastage</b></h3></button></a>
    			...
    			<div class="col-md-4">
					<div class="card">
						<div class="card-body " style="margin-top: 18px">
						<a href="outWastage.php"><button class="card-body btn btn-danger" style="height:150px; width: 100%"><h1><i class="fa fa-list-alt"></i></h1><br><h3 style="padding-top: 10px;"><b>Outlet Wastage</b></h3></button></a>
    			...
    			<div class="col-md-4">
					<div class="card">
						<div class="card-body " style="margin-top: 18px">
						<a href="othWastage.php"><button class="card-body btn btn-danger" style="height:150px; width: 100%"><h1><i class="fa fa-list-alt"></i></h1><br><h3 style="padding-top: 10px;"><b>Total Production</h3></button></a>
