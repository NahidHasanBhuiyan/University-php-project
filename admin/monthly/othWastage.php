...
<html>
<head>
<title>Bhuiyan Group | Monthly Analysis | Total Production</title>
            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left" style="background-color: #00bfff; ">
							<div class="logo-nam">
									 <h1 class="text-center" style="padding: 5px; color: #fff"><b>Total Production</b></h1> 
						...
						<div class="col-md-12 chart-layer1-left"> 
							...
							<div class="span-2c">  
								<?php
										...
										$query1 = $conn->query("SELECT SUM(totalPrice) as Total1 FROM madeproduct WHERE mMonth='01' AND mYear='$year'  GROUP BY mMonth");
										$fetch1 = $query1-> fetch_assoc();
										$month1 = $fetch1['Total1'];

										$query2 = $conn->query("SELECT SUM(totalPrice) as Total2 FROM madeproduct WHERE mMonth='02' AND mYear='$year'  GROUP BY mMonth");
										$fetch2 = $query2-> fetch_assoc();
										$month2 = $fetch2['Total2'];

										$query3 = $conn->query("SELECT SUM(totalPrice) as Total3 FROM madeproduct WHERE mMonth='03' AND mYear='$year' GROUP BY mMonth");
										$fetch3 = $query3-> fetch_assoc();
										$month3 = $fetch3['Total3'];

										$query4 = $conn->query("SELECT SUM(totalPrice) as Total4 FROM madeproduct WHERE mMonth='04' AND mYear='$year' GROUP BY mMonth");
										$fetch4 = $query4-> fetch_assoc();
										$month4 = $fetch4['Total4'];

										$query5 = $conn->query("SELECT SUM(totalPrice) as Total5 FROM madeproduct WHERE mMonth='05' AND mYear='$year' GROUP BY mMonth");
										$fetch5 = $query5-> fetch_assoc();
										$month5 = $fetch5['Total5'];

										$query6 = $conn->query("SELECT SUM(totalPrice) as Total6 FROM madeproduct WHERE mMonth='06' AND mYear='$year' GROUP BY mMonth");
										$fetch6 = $query6-> fetch_assoc();
										$month6 = $fetch6                              ['Total6'];

										$query7 = $conn->query("SELECT SUM(totalPrice) as Total7 FROM madeproduct WHERE mMonth='07'AND mYear='$year' GROUP BY mMonth");
										$fetch7 = $query7-> fetch_assoc();
										$month7 = $fetch7['Total7'];

										$query8 = $conn->query("SELECT SUM(totalPrice) as Total8 FROM madeproduct WHERE mMonth='08' AND mYear='$year' GROUP BY mMonth");
										$fetch8 = $query8-> fetch_assoc();
										$month8 = $fetch8['Total8'];

										$query9 = $conn->query("SELECT SUM(totalPrice) as Total9 FROM madeproduct WHERE mMonth='09' AND mYear='$year' GROUP BY mMonth");
										$fetch9 = $query9-> fetch_assoc();
										$month9 = $fetch9['Total9'];

										$query10 = $conn->query("SELECT SUM(totalPrice) as Total10 FROM madeproduct WHERE mMonth='10' AND mYear='$year' GROUP BY mMonth");
										$fetch10 = $query10-> fetch_assoc();
										$month10 = $fetch10['Total10'];

										$query11 = $conn->query("SELECT SUM(totalPrice) as Total11 FROM madeproduct WHERE mMonth='11' AND mYear='$year' GROUP BY mMonth");
										$fetch11 = $query11-> fetch_assoc();
										$month11 = $fetch11['Total11'];

										$query12 = $conn->query("SELECT SUM(totalPrice) as Total12 FROM madeproduct WHERE mMonth='12' AND mYear='$year' GROUP BY mMonth");
								...
								?>
	                        		<h3 class="tlt">Total Production</h3>
				...
				<div class="row">
					<div class="col-md-12 chart-layer2-left" style="margin-top: 30px">
					        ...
					        <div class='bar_group'>
					        		...
					        		<?php
					        			$jan = $conn->query("SELECT SUM(totalPrice) as janTotal FROM madeproduct WHERE mMonth='01' AND mYear='$year' GROUP BY mMonth");
					        			$jan1 = $jan->fetch_assoc();
					        				
					        		?>
									<div class='bar_group__bar thin' label='Total Production' show_values='true' tooltip='true' value='<?php echo $jan1['janTotal']?>'></div>
									...
									<?php
					        			$feb = $conn->query("SELECT SUM(totalPrice) as febTotal FROM madeproduct WHERE mMonth='02' AND mYear='$year' GROUP BY mMonth");
					        			$feb1 = $feb->fetch_assoc();
					        				
					        		?>
									<div class='bar_group__bar thin' label='Total Production' show_values='true' tooltip='true' value='<?php echo $feb1['febTotal']?>'></div>
									...
									<?php
					        			$mar = $conn->query("SELECT SUM(totalPrice) as marTotal FROM madeproduct WHERE mMonth='03' AND mYear='$year' GROUP BY mMonth");
					        			$mar1 = $mar->fetch_assoc();
					        				
					        		?>
									<div class='bar_group__bar thin' label='Total Production' show_values='true' tooltip='true' value='<?php echo $mar1['marTotal']?>'></div>
									


									<div class='bar_group__bar ' label='' value=''><h1 class="alert">April</h1></div>
									<?php
					        			$apr = $conn->query("SELECT SUM(totalPrice) as aprTotal FROM madeproduct WHERE mMonth='04' AND mYear='$year' GROUP BY mMonth");
					        			$apr1 = $apr->fetch_assoc();
					        				
					        		?>
									<div class='bar_group__bar thin' label='Total Production' show_values='true' tooltip='true' value='<?php echo $apr1['aprTotal']?>'></div>
									


									<div class='bar_group__bar ' label='' value=''><h1 class="alert">May</h1></div>
									<?php
					        			$may = $conn->query("SELECT SUM(totalPrice) as mayTotal FROM madeproduct WHERE mMonth='05' AND mYear='$year' GROUP BY mMonth");
					        			$may1 = $may->fetch_assoc();
					        				
					        		?>
									<div class='bar_group__bar thin' label='Total Production' show_values='true' tooltip='true' value='<?php echo $may1['mayTotal']?>'></div>
									

									<div class='bar_group__bar ' label='' value=''><h1 class="alert">June</h1></div>
									<?php
					        			$june = $conn->query("SELECT SUM(totalPrice) as juneTotal FROM madeproduct WHERE mMonth='06' AND mYear='$year' GROUP BY mMonth");
					        			$june1 = $june->fetch_assoc();
					        				
					        		?>
									<div class='bar_group__bar thin' label='Total Production' show_values='true' tooltip='true' value='<?php echo $june1['juneTotal']?>'></div>
									

									<div class='bar_group__bar ' label='' value=''><h1 class="alert">July</h1></div>
									<?php
					        			$july = $conn->query("SELECT SUM(totalPrice) as julyTotal FROM madeproduct WHERE mMonth='07' AND mYear='$year' GROUP BY mMonth");
					        			$july1 = $july->fetch_assoc();
					        				
					        		?>
									<div class='bar_group__bar thin' label='Total Production' show_values='true' tooltip='true' value='<?php echo $july1['julyTotal']?>'></div>
									


									<div class='bar_group__bar ' label='' value=''><h1 class="alert">August</h1></div>
									<?php
					        			$aug = $conn->query("SELECT SUM(totalPrice) as augTotal FROM madeproduct WHERE mMonth='08' AND mYear='$year' GROUP BY mMonth");
					        			$aug1 = $aug->fetch_assoc();
					        				
					        		?>
									<div class='bar_group__bar thin' label='Total Production' show_values='true' tooltip='true' value='<?php echo $aug1['augTotal']?>'></div>
									


									<div class='bar_group__bar ' label='' value=''><h1 class="alert">September</h1></div>
									<?php
					        			$sep = $conn->query("SELECT SUM(totalPrice) as sepTotal FROM madeproduct WHERE mMonth='09' AND mYear='$year' GROUP BY mMonth");
					        			$sep1 = $sep->fetch_assoc();
					        				
					        		?>
									<div class='bar_group__bar thin' label='Total Production' show_values='true' tooltip='true' value='<?php echo $sep1['sepTotal']?>'></div>
									


									<div class='bar_group__bar ' label='' value=''><h1 class="alert">October</h1></div>
									<?php
					        			$oct = $conn->query("SELECT SUM(totalPrice) as octTotal FROM madeproduct WHERE mMonth='10' AND mYear='$year' GROUP BY mMonth");
					        			$oct1 = $oct->fetch_assoc();
					        				
					        		?>
									<div class='bar_group__bar thin' label='Total Production' show_values='true' tooltip='true' value='<?php echo $oct1['octTotal']?>'></div>
									


									<div class='bar_group__bar ' label='' value=''><h1 class="alert">November</h1></div>
									<?php
					        			$nov = $conn->query("SELECT SUM(totalPrice) as novTotal FROM madeproduct WHERE mMonth='11' AND mYear='$year' GROUP BY mMonth");
					        			$nov1 = $nov->fetch_assoc();
					        				
					        		?>
									<div class='bar_group__bar thin' label='Total Production' show_values='true' tooltip='true' value='<?php echo $nov1['novTotal']?>'></div>
									


									<div class='bar_group__bar ' label='' value=''><h1 class="alert">December</h1></div>
									<?php
					        			$dec = $conn->query("SELECT SUM(totalPrice) as decTotal FROM madeproduct WHERE mMonth='12' AND mYear='$year' GROUP BY mMonth");
					        			$dec1 = $dec->fetch_assoc();
					        				
					        		?>
									<div class='bar_group__bar thin' label='Total Production' show_values='true' tooltip='true' value='<?php echo $dec1['decTotal']?>'></div>
