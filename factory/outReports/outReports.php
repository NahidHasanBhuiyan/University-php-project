...
<html>
<head>
<title>Bhuiyan Group | Reports | Outlet Reports</title>
            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left" style="background-color: #00bfff; ">
							<div class="logo-nam">
									 <h1 class="text-center" style="padding: 5px; color: #fff"><b>Outlet Reports</b></h1> 
...
<!--market updates updates-->
	 <div class="container-fluid" >
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                	<div class="row">
                                		<div class="col-md-12">
		                                    <h3 class="alert alert-info"><b class="text-left">Outlet Today Reports :</b ></h3>
		                                    </div>
        ...
        <!-- Static Table End -->
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="admin-pro-accordion-wrap responsive-mg-b-30">
                            ...
                            <div class="panel-group adminpro-custon-design" id="accordion">
                                ...
                                <?php
                                		$out = $conn->query("SELECT * FROM croutlet");
                                		
                                		while($outlet = $out->fetch_assoc()):
                                			$outle = $outlet['outName'];
                                			$was = $conn->query("SELECT wasOutPrName,SUM(wasOutQuantity) AS totalQ,wasOutUnit,SUM(wasOutPrice) AS totalP FROM wastageoutlet WHERE wasOutlet='$outle' AND wasStatus='Confirmed' AND wasDate='$dat' GROUP BY wasOutlet");
                                			$wastage = $was->fetch_assoc();
                                ?>
                                <div class="panel panel-success">
                                    <div class="panel-heading accordion-head">
                                    	
                                        <h4 class="panel-title text-center">
                                            <a data-toggle="collapse"  href="#<?php echo $outlet['sl']?>">
									 			<span class="badge text-capitalize"><?php echo $outlet['outName']?></span> </a>
                                        </h4>
                                    </div>
                                    <div id="<?php echo $outlet['sl']?>" class="panel-collapse panel-ic collapse">
                                        <div class="panel-body admin-panel-content animated bounce">
                                            <div class="data-table-area mg-tb-15" >
									            <div class="container-fluid">
									                <div class="row">
									                	<div class="col-md-6 col-sm-6">
									                		<h4 class="alert bg-danger"><b>Todays Wastage :</b></h4>
									                	</div>
									                	<div class="col-md-6 col-sm-6">
									                		<h4 class="alert bg-danger"><b>BDT <?php echo $wastage['totalP'];?></b></h4>
									                	</div>
									                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									                        <div class="sparkline13-list">
									                            ...
									                            <div class="sparkline13-graph">
									                                <div class="datatable-dashv1-list custom-datatable-overright">
									                                    ...
									                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
									                                        ...
									                                        <tbody>
									                                        	<?php 
									                                        	$wa = $conn->query("SELECT wasOutPrName,SUM(wasOutQuantity) AS totalQ,wasOutUnit,SUM(wasOutPrice) AS totalP FROM wastageoutlet WHERE wasOutlet='$outle' AND wasStatus='Confirmed' AND wasDate='$dat' GROUP BY wasOutPrName");
									                                        	$i=1;
									                                        		while($wastag = $wa->fetch_assoc()):
									                                            ...
									                                            <tr>
									                                                <td></td>
									                                                <td><?php echo $i++?></td>
									                                                <td><?php echo $wastag['wasOutPrName']?></td>
									                                                
									                                                <td><?php echo $wastag['totalQ']?></td>
									                                                <td><?php echo $wastag['wasOutUnit']?></td>
									                                                <td><?php echo $wastag['totalP']?> <span>TK</span></td>
									                                            </tr>
									                                        <?php endwhile;?>
         ...
         <!--End Outlet Today Report -->

         <!--Start Outlet Previous Day Report -->
