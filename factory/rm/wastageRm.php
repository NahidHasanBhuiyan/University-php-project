...
<html>
<head>
<title>Bhuiyan Group | Factory | Wastage Row Material</title>
            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left" style="background-color: #00bfff; ">
							<div class="logo-nam">
									 <h1 class="text-center" style="padding: 5px; color: #fff"><b>Wastage RM</b></h1> 
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="div">
                                                	...
                                                	<h3 class="alert bg-primary text-capitalize">Wastage Row Material</h3>
		                                ...
		                                <tbody>
		                                	...
		                                	$today = date('d-m-Y');
		                                		...
		                                		while($dist= $dis->fetch_assoc()):
		                                			...
		                                			$wastageRmName = $_POST['wastageRmName'];
		                                			$wastageRmQuantity = $_POST['wastageRmQuantity'];
		                                			$wastageRmUnit = $_POST['wastageRmUnit'];
		                                			$wastageRmPrice = $_POST['wastageRmPrice'];
		                                			
		                                			$wastageRmStatus = "Pending";
		                                			$wastageRmDate = date('d-m-Y');



		                                			if(empty($wastageRmQuantity) ){
											$message = "<p class='alert alert-danger'>Field Must Not Be Empty</p>";

											}else{
												

													$conn-> query("INSERT INTO wastagerm (wastageRmName,wastageRmQuantity,wastageRmUnit,wastageRmPrice,wastageRmStatus,wastageRmDate,color) VALUES('$wastageRmName','$wastageRmQuantity','$wastageRmUnit','$wastageRmPrice','$wastageRmStatus','$wastageRmDate','red')");
											$message = "<p class='alert alert-success'>Successfully added Wastage RM!</p>";
											...
											echo $message;
		                                		...
		                                		$colo = $conn->query("SELECT * FROM wastagerm WHERE  wastageRmDate='$today' AND wastageRmName='$product'");
			                                ...
			                                <tr>
			                                    ...
			                                    <td class="text-capitalize">
			                                    	<input name="wastageRmName"  value="<?php echo $dist['pRmName']?>" type="text" class="form-control text-capitalize" readonly>
			                                    </td>
			                                    <td>
		                                            <input  name="wastageRmQuantity"   type="number" min="1" value="">
		                                        </td>
			                                    <td class="text-capitalize">
			                                    	
													
													<input name="wastageRmUnit"  value="<?php echo $dist['pRmUnit']?>" type="text" class="form-control" readonly>

			                                    </td>
			                                    <td>
		                                            <input  name="wastageRmPrice"   type="number" min="1" value="">
		                                        </td>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                <?php
                                	$row = $conn->query("SELECT * FROM wastagerm WHERE wastageRmStatus='Pending'");
                                	$i=1;
                                ...
                                <tr>
                                    <td><?php echo $i++;?></td>
                                    <td><?php echo $material['wastageRmName']?></td>
                                    <td><?php echo $material['wastageRmQuantity']?></td>
                                    <td><?php echo $material['wastageRmUnit']?></td>
                                    <td><?php echo $material['wastageRmPrice']?></td>
                                    
                                    
                                    <td>
                                         <a onclick="javascript: return confirm('Are You Sure?');" href="inc/wastageRmConfirm.php?sl=<?php echo $material['sl']?>"><button data-toggle="tooltip" title="All ok" class="pd-setting-ed"><i class="fa fa-check" aria-hidden="true"></i></button></a>
                                        <a onclick="javascript: return confirm('Please Confirm Delation');" href="inc/wastageRmDelete.php?sl=<?php echo $material['sl']?>"><button data-toggle="tooltip" title="Delete" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                    </td>
                                </tr>
                            <?php endwhile;?>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h3 class="alert bg-success"><b>Wastage RM List</b></h3>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="Wastage RM Name" data-editable="false">Wastage RM Name</th>
                                        ...
                                        <tbody>
                                			<?php
												...
												$j=1;
                               					$was = $conn->query("SELECT * FROM wastagerm WHERE (wastageRmStatus = 'Confirmed' AND wastageRmDate='$today' OR wastageRmDate='$previousDay') ORDER BY sl DESC");
											...
											<tr>
												<td></td>
												<td><?php echo $j++;?></td>
			                                    <td><?php echo $prwastage['wastageRmName']?></td>
			                                    <td><?php echo $prwastage['wastageRmQuantity']?></td>
			                                    <td><?php echo $prwastage['wastageRmUnit']?></td>
			                                    <td><?php echo $prwastage['wastageRmPrice']?></td>
			                                </tr>
			                                <?php endwhile;?>
                                		</tbody>
                                    </table>
