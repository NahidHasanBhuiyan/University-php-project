...
<html>
<head>
<title>Bhuiyan Group | Factory | Row Material</title>
            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left" style="background-color: #00bfff; ">
							<div class="logo-nam">
									 <h1 class="text-center" style="padding: 5px; color: #fff"><b>Row Material</b></h1> 
									...
									<li class="dropdown profile_details_drop">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
											<div class="profile_img">	
												...
												<div class="user-name" style="margin-left: 150px">
										...
										<ul class="dropdown-menu drp-mnu" style="margin-left: 7px">
...
<!--market updates updates-->
	 <div class="container-fluid" >
		...
		<div class="row" style="margin-top: 100px">
			<div class="col-md-4">
				<div class="card " style="margin-top: 18px">
					<a href="byout_sum.php"><button class="card-body btn btn-info" style="height: 190px; width: 100%"><h1><i class="fa fa-shopping-bag fa-lg"></i></h1><h3 style="padding-top: 10px;"><b>Purchase Row Material</b></h3></button></a>
				</div>
			</div>
			<div class="col-md-4">
				<div class="card " style="margin-top: 18px" >

					<a href="usedRm.php"><button class="card-body btn btn-info" style="height: 190px; width: 100%"><h1><i class="fa fa-repeat"></i></h1><h3 style="padding-top: 10px"><b>Used Row Material</b></h3></button></a>
				</div>
			</div>
			<div class="col-md-4">
				<div class="card " style="margin-top: 18px" >
				<a href="wastageRm.php"><button class="card-body btn btn-danger" style="height: 190px; width: 100%"><h1><i class="fa fa-trash fa-lg"></i></h1><h3 style="padding-top: 10px"><b>Wastage  Row Material</b></h3></button></a>
				</div>
			</div>
		...
		<p class="alert bg-success " style="text-align: center; margin-top:120px">Powered By @ NAHID HASAN BHUIYAN & TEAM</p>
