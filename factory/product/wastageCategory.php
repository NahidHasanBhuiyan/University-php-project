...
<html>
<head>
<title>Bhuiyan Group | Factory | Wastage Category</title>
            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left" style="background-color: #00bfff; ">
							<div class="logo-nam">
									 <h1 class="text-center" style="padding: 5px; color: #fff"><b>Wastage Category</b></h1> 
...
<!--market updates updates-->
	 <div class="container-fluid" >
		...
		<div class="panel" >
			<div class="row">
				<?php
					$outlet = $conn->query("SELECT prCategoryName,sl FROM category");
					while($outlet1=$outlet->fetch_assoc()):

				?>
				<div class="col-md-4">
					<div class="card">
						<div class="card-body " style="margin-top: 18px">
						<a href="wastagePr.php?sl=<?php echo $outlet1['sl']?>"><button class="card-body btn btn-success text-capitalize" style="height:150px; width: 100%"><h3 style="padding-top: 10px;"><b><?php echo $outlet1['prCategoryName']?></b></h3></button></a>
