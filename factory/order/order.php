...
<html>
<head>
<title>Bhuiyan Group | Factory | Advance Orders</title>
            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left" style="background-color: #00bfff">
							<div class="logo-nam">
									 <h1 class="text-center" style="padding: 5px; color: #FFF"><b>Advance Orders</b></h1> 
			...
			<div class="row">
				<div class="col-md-4" >
					<div class="panel panel-success" style=""> 
			    		 <div class="panel-footer " style="background-color: green; color: #fff">
			    		      <h2 class="text-center "><b>Advanced Orders</b></h2>
			    		  </div> 
			    		  <div class="panel-body" style="height: 300px;background-color: black; color: #fff ">
			    		      <h2 class="panel text-center" style="margin-top: 80px"><strong>Total <span class="badge badge-danger counter" style="font-size: 18px"><?php echo $row;?></span></strong></h2>
    			...
    			<div class="col-md-8">
    				<div class="row">
    					<?php
    						$outt = $conn->query("SELECT * FROM croutlet");
    						while($outle = $outt->fetch_assoc()):
    							$o = $outle['outName'];
    							$num = $conn->query("SELECT * FROM advanceorder WHERE outlet='$o' AND factoryStatus='Pending'");
    							$r = $num->num_rows;
    					?>
		    			<div class="col-2 col-md-4 col-sm-4">
					    	...
					    	<div class="card" style="margin-top: 5px"> 
					    		 ...
					    		 <a href="outletOrder.php?sl=<?php echo $outle['sl']?>">
					    		 	<button class="btn btn-info" style="width: 100%">
					    		 		<h1 class="text-center"><i class="fa fa-cog"></i></h1><br>
					    		      <h4 class="text-center text-capitalize" ><b ><?php echo $outle['outName']?></b></h4>
					    		      <h5 class="panel" style="color: blue"><strong>Order <span class="counter"><?php echo $r?></span></strong></h5>
					    		     </button>
					    		 </a>
