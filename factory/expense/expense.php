		...
		<div class="row" style="margin-top: 100px">
			<div class="col-md-4">
				<div class="card " style="margin-top: 18px">
					<a href="fexpense.php"><button class="card-body btn btn-danger" style="height: 190px; width: 100%"><h1><i class="fa fa-shopping-bag fa-lg"></i></h1><h3 style="padding-top: 10px;"><b>Factory Expense</b></h3></button></a>
				</div>
			</div>
			<div class="col-md-4">
				<div class="card " style="margin-top: 18px" >

					<a href="rNd.php"><button class="card-body btn btn-danger" style="height: 190px; width: 100%"><h1><i class="fa fa-repeat"></i></h1><h3 style="padding-top: 10px"><b>Research & Development</b></h3></button></a>
				</div>
			</div>
