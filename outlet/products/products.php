...
<html>
<head>
<title>Diana | <?php echo $_SESSION['outName'];?> | Products & Inventory</title>
            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left" style="background-color: #00bfff; ">
							<div class="logo-nam">
									 <h1 class="text-center" style="padding: 5px; color: #fff"><b>Products & Inventory</b></h1> 
...
<!--market updates updates-->
	 <div class="container-fluid" >
		...
		<div class="row" style="margin-top: 10px">
			<div class="col-md-4">
				<div class="card " style="margin-top: 18px">
					<a href="recCategory.php"><button class="card-body btn btn-info" style="height: 190px; width: 100%"><h1><i class="fa fa-shopping-bag fa-lg"></i></h1><h3 style="padding-top: 10px;"><b>Products Received</b></h3></button></a>
				</div>
			</div>
			<div class="col-md-4">
				<div class="card " style="margin-top: 18px" >

					<a href="stockCategory.php"><button class="card-body btn btn-info" style="height: 190px; width: 100%"><h1><i class="fa fa-history"></i></h1><h3 style="padding-top: 10px"><b>Todays Stock</b></h3></button></a>
				</div>
			</div>
			<div class="col-md-4">
				<div class="card " style="margin-top: 18px" >
				<a href="wastageCategory.php"><button class="card-body btn btn-danger" style="height: 190px; width: 100%"><h1><i class="fa fa-trash fa-lg"></i></h1><h3 style="padding-top: 10px"><b>Product Wastage</b></h3></button></a>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-md-4">
				<div class="card " style="margin-top: 18px" >
				<a href="cat.php"><button class="card-body btn btn-info" style="height: 190px; width: 100%"><h1><i class="fa fa-exchange fa-lg"></i></h1><h3 style="padding-top: 10px"><b>Product Transfer</b></h3></button></a>
				</div>
			</div>
			<div class="col-md-4">
				<div class="card " style="margin-top: 18px" >
				<a href="order.php"><button class="card-body btn btn-info" style="height: 190px; width: 100%"><h1><i class="fa fa-cart-plus fa-lg"></i></h1><h3 style="padding-top: 10px"><b>New Advance Order</b></h3></button></a>
				</div>
			</div>
		...
		<p class="alert bg-info " style="text-align: center; margin-top:120px">Powered By @ NAHID HASAN BHUIYAN & TEAM</p>
