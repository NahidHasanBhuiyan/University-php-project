...
<html>
<head>
<title>Diana | <?php echo $outlet;?> | Category</title>
			...
			<div class="row">
				<?php
					...
					while($outlet1=$outlet2->fetch_assoc()):
						...
						$pro = $conn->query("SELECT * FROM productdistribution WHERE outletStatus='Pending' AND catName='$categor' AND prDistOutleName='$outlet' ");
						$row = $pro-> num_rows;
				...
				<div class="col-md-4">
					<div class="card">
						...
						<a href="proReceive.php?sl=<?php echo $outlet1['sl']?>"><button class="card-body btn btn-success text-capitalize" style="height:150px; width: 100%"><h3 style="padding-top: 10px;"><b><?php echo $outlet1['prCategoryName']?></b> <span class="badge"> <?php echo $row?></span></h3></button></a>
