...
<html>
<head>
<title>Diana | <?php echo $_SESSION['outName'];?> | <?php echo $category?> Receive</title>
            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left" style="background-color: #00bfff; ">
							<div class="logo-nam">
									 <h1 class="text-center text-capitalize" style="padding: 5px; color: #fff"><b><?php echo $category?> Receive</b></h1> 
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            <h2 class="alert bg-danger"><b>Product Receive</b></h2>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                <?php
                                	$pro = $conn->query("SELECT * FROM productdistribution WHERE outletStatus='Pending' AND prDistOutleName='$outlet' AND catName='$category' ORDER BY sl DESC");
                                	$i=1;
                                	while($receive=$pro->fetch_assoc()):

                               	 ?>
                                <tr>
                                    <td><?php echo $i++;?></td>
                                    <td><?php echo $receive['prDistDate']?></td>
                                    <td class="text-capitalize"><?php echo $receive['prDistPrName']?></td>
                                    <td><?php echo $receive['prDistQuantity']?></td>
                                    <td class="text-capitalize"><?php echo $receive['prDistUnit']?></td>
                                    <td><?php echo $receive['distPerUnitPrice']?></td>
                                    <td><?php echo $receive['distTotalPrice']?></td>
                                    <td>
                                        <a href="inc/proReceiveConfirm.php?sl=<?php echo $receive['sl']?>&key=<?php echo $sl?>" onclick="javascript: return confirm('Sure to Accept?');"><button data-toggle="tooltip" title="Accept" class="pd-setting-ed"><i class="fa fa-check" aria-hidden="true"></i></button></a>
                                        <a href="inc/proReceiveEdit.php?sl=<?php echo $receive['sl']?>&key=<?php echo $sl?>" onclick="javascript: return confirm('Please Confirm Mismatch?');"><button data-toggle="tooltip" title="Mismatch" class="pd-setting-ed"><i class="fa fa-edit" aria-hidden="true"></i></button></a>
                                    </td>
                                </tr>
                            <?php endwhile;?>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h3 class="alert bg-success"><b>Product Receive List</b></h3>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <tbody>
                                			<?php
                                				...
                                				$dayPrevious = date('d-m-Y',strtotime($today.'-2 day'));
                                				$pr = $conn->query("SELECT * FROM productdistribution WHERE outletStatus='Confirmed' AND prDistOutleName='$outlet'  AND catName='$category' AND (prDistDate='$today' OR prDistDate='$previousDay' OR prDistDate='$dayPrevious') ORDER BY sl DESC" );
                                				$j=1;
			                                ...
			                                <tr>
			                                    <td></td>
			                                    <td><?php echo $j++;?></td>
			                                    <td><?php echo $produ['prDistDate']?></td>
