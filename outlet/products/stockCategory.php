			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="card">
						...
						<a href="sold.php?sl=<?php echo $outlet1['sl']?>"><button class="card-body btn btn-success text-capitalize" style="height:150px; width: 100%"><h3 style="padding-top: 10px;"><b><?php echo $outlet1['prCategoryName']?></b> </h3></button></a>
