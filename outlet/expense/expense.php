...
<html>
<head>
<title>Diana | <?php echo $_SESSION['outName'];?> | Expense & Balance</title>
            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left" style="background-color: #00bfff; ">
							<div class="logo-nam">
									 <h1 class="text-center" style="padding: 5px; color: #fff"><b>Expense & Balance</b></h1> 
		...
		<div class="row" style="margin-top: 100px">
			<div class="col-md-4">
				<div class="card " style="margin-top: 18px">
					<a href="ending.php"><button class="card-body btn btn-info" style="height: 190px; width: 100%"><h1><i class="fa fa-shopping-bag fa-lg"></i></h1><h3 style="padding-top: 10px;"><b>Ending Balance</b></h3></button></a>
				</div>
			</div>
			<div class="col-md-4">
				<div class="card " style="margin-top: 18px" >

					<a href="outExp.php"><button class="card-body btn btn-danger" style="height: 190px; width: 100%"><h1><i class="fa fa-trash"></i></h1><h3 style="padding-top: 10px"><b>Expense</b></h3></button></a>
				</div>
			</div>
