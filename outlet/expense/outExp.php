...
<html>
<head>
<title>Diana | <?php echo $_SESSION['outName'];?> | Expense</title>
            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left" style="background-color: #00bfff; ">
							<div class="logo-nam">
									 <h1 class="text-center" style="padding: 5px; color: #fff"><b>Expense</b></h1> 
...
<!--market updates updates-->
	 <div class="container-fluid" >
		<p class="alert bg-info text-right">Date: <?php echo $date;?></p>
								...
								<div class="panel panel-success" style="margin-top: 10px">
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="div">
                                                	<h3 class="alert bg-danger"><?php echo $outlet?> Expense</h3>
                                                </div>
		                                ...
		                                <tbody>
		                                	<?php
		                                	$today = date('d-m-Y');
		                                		$dis = $conn->query("SELECT * FROM outletexpense WHERE expOutlet='$outlet' GROUP BY outExpName ORDER BY outExpName");
		                                		$i=1;
		                                		while($dist= $dis->fetch_assoc()):
													...
													$message = "<p class='alert alert-danger'>Field Must Not Be Empty</p>";
														...
														$conn->query("INSERT INTO outletexpense (expOutlet,outExpName,OutExpDetails,OutExpAmount,outExpType,outExpStatus,outExpDate,outMonth,color) VALUES('$outlet','$facWasPrName','$facWasPrDetails','$facWasPrAmount','$facWasPrType','$facWasPrStatus','$facWasPrDate','$month','red')");
											$message = "<p class='alert alert-success'>Successfully added Outlet Expense!</p>";
													...
													echo $message;
		                                				...
		                                				$product = $dist['outExpName'];
				                                		$colo = $conn->query("SELECT * FROM outletexpense WHERE outExpDate='$today' AND outExpName='$product'");
			                                ...
			                                <tr>
			                                    ...
			                                    <td class="text-capitalize">
			                                    	<input name="facWasPrName"  value="<?php echo $dist['outExpName']?>" type="text" class="form-control text-capitalize" readonly>
			                                    </td>
			                                    <td class="text-capitalize">
			                                    	
													
													<input name="facWasPrDetails"  value="<?php echo $dist['OutExpDetails']?>" type="text" class="form-control" readonly>

			                                    </td>
			                                    <td class="text-capitalize">
			                                    	
													
													<input name="facWasPrType"  value="<?php echo $dist['outExpType']?>" type="text" class="form-control" readonly>
                                ...
                                <div class="panel panel-success" style="margin-top: 10px">
                                	<?php
                                		if(isset($_POST['addOutExp'])){
                                			$outExpName = $_POST['outExpName'];
                                			$OutExpDetails = $_POST['OutExpDetails'];
                                			$OutExpAmount = $_POST['OutExpAmount'];
                                			$OutExpNotes = $_POST['OutExpNotes'];
                                			$outExpType = $_POST['outExpType'];
                                			$outExpStatus = "Pending";
                                			$outExpDate = date('d-m-Y');

                                			
                                			if(empty($outExpName) || empty($OutExpDetails) || empty($OutExpAmount) || empty($outExpType)){
											$message = "<p class='alert alert-danger'>Field Must Not Be Empty</p>";

											}else{
												
											$conn->query("INSERT INTO outletexpense (expOutlet,outExpName,OutExpDetails,OutExpAmount,OutExpNotes,outExpType,outExpStatus,outExpDate,outMonth,color) VALUES('$outlet','$outExpName','$OutExpDetails','$OutExpAmount','$OutExpNotes','$outExpType','$outExpStatus','$outExpDate','$month','red')");
											$message = "<p class='alert alert-success'>Successfully added Outlet Expense!</p>";
											}
											echo $message;
                                		}
								...
								<form action="" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="div">
                                                	<h3 class="alert alert-danger">Outlet Expense</h3>
                                                </div>
                                                    
                                                    <div class="form-group" style="margin-top: 8px;">
                                                    	<label for=""><i class="fa fa-pencil" aria-hidden="true"></i> Expense Name</label>
                                                        
                                                        <input name="outExpName" type="text" class="form-control" placeholder="Ex: Buying Paper">
                                                    </div>
                                                    <div class="form-group" style="margin-top: 8px;">
                                                    	<label for=""><i class="fa fa-cog" aria-hidden="true"></i> Details</label>
                                                        
                                                        <input name="OutExpDetails" type="text" class="form-control" placeholder="Ex: Finance Report Book">
                                                    </div>
                                                    <div class="form-group" style="margin-top: 8px;">
                                                    	<label for=""><i class="fa fa-money" aria-hidden="true"></i> Amount(BDT)</label>
                                                        
                                                        <input name="OutExpAmount" type="text" class="form-control" placeholder="Ex: 200">
                                                    </div>
                                                    <div class="form-group" style="margin-top: 8px;">
                                                    	<label for=""><i class="fa fa-envelope" aria-hidden="true"></i> Notes (if any)</label>
                                                        
                                                        <input name="OutExpNotes" type="text" class="form-control" placeholder="Ex: For the purpose of factory finance report">
                                                    </div>
                                                    <div class="chosen-select-single mg-b-20" style="margin-top: 8px;">
		                                                ...
		                                                <select name="outExpType" class="chosen-select" tabindex="-1">
                                        ...
                                        <div class="row" style="margin-top: 8px">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center mg-b-pro-edt custom-pro-edt-ds">
                                                    <input name="addOutExp" class="btn btn-danger" type="submit" value="Add Expense">
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h3 class="alert alert-danger"><b>Expense List</b></h3>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <tbody>
                                        	<?php
                                        		$out = $conn->query("SELECT * FROM outletexpense WHERE expOutlet='$outlet' ORDER BY sl DESC");
                                        		$i=1;
                                        		while($outExp = $out->fetch_assoc()):
                                        	?>
                                            <tr>
                                                <td></td>
                                                <td><?php echo $i++;?></td>
                                                <td><?php echo $outExp['outExpDate']?></td>
												...
												<?php
													if($outExp['outExpStatus']=="Pending"){

												?>
                                                <td>
			                                        <a onclick="javascript: return confirm('Please Confirm All Ok?');" href="inc/expenseConfirm.php?sl=<?php echo $outExp['sl']?>"><button data-toggle="tooltip" title="All ok" class="pd-setting-ed"><i class="fa fa-check" aria-hidden="true"></i></button></a>
			                                        <a onclick="javascript: return confirm('Please Confirm Delate?');" href="inc/expenseDelete.php?sl=<?php echo $outExp['sl']?>"><button data-toggle="tooltip" title="Delete" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
			                                    </td>
			                                    <?php }?>
                                            </tr>
                                            <?php endwhile;?>
