...
<html>
<head>
<title>Bhuiyan Group | Cake N Bake</title>
            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left" style="background-color: #00bfff; padding: 3px">
							<div class="logo-nam">
									 <h1 class="text-center text-uppercase" style="padding: 5px;color: #FFF;"><b><?php echo $_SESSION['outName'];?></b></h1> 
...
<div class="inner-block" style="background-image: url('images/b5.jpg'); background-size: cover; background-attachment: fixed;">
<!--market updates updates-->
	 <div class="container-fluid" >
		...
		<div class="row" style="margin-top: 100px">
			<div class="col-md-4">
				<div class="card " style="margin-top: 18px">
					<a href="outlet/products/products.php"><button class="card-body btn btn-info text-uppercase" style="height: 190px; width: 100%"><h1><i class="fa fa-cart-plus fa-lg"></h1></i></h1><h3 style="padding-top: 10px;">Products & Inventory</h3></button></a>
				</div>
			</div>
			
			<div class="col-md-4">
				<div class="card " style="margin-top: 18px" >
				<a href="outlet/expense/expense.php"><button class="card-body btn btn-info text-uppercase" style="height: 190px; width: 100%"><h1><i class="fa fa-money fa-lg"></i></h1><h3 style="padding-top: 10px">Expenses & Balance</h3></button></a>
				</div>
			</div>
			<div class="col-md-4">
				<div class="card " style="margin-top: 18px" >
					<a href="outlet/reports/reports.php"><button class="card-body btn btn-info text-uppercase" style="height: 190px; width: 100%"><h1><i class="fa fa-bar-chart fa-lg"></i></h1><h3 style="padding-top: 10px">Outlet Reports</h3>
		...
		<p class="alert" style="text-align: center; margin-top: 50px;background-color: #00bfff; color: #FFF; margin-top: 200px">Powered By @ NAHID HASAN BHUIYAN & TEAM</p>
